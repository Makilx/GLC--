...
namespace GLEngine {
    ...
    class Input {
        ...
        static glm::vec2 lockPos;
        static glm::vec2 pendingMouseDelta;
        static glm::vec2 warpTarget;
        static glm::vec2 mouseDelta;
        static bool ignoreWarpEvent;
        static std::array<bool, GLFW_KEY_LAST + 1> pressingKeys;
        static std::array<bool, GLFW_KEY_LAST + 1> previousPressingKeys;
        static std::array<bool, GLFW_MOUSE_BUTTON_LAST + 1> pressingMouseButtons;
        static std::array<bool, GLFW_MOUSE_BUTTON_LAST + 1> previousPressingMouseButtons;
